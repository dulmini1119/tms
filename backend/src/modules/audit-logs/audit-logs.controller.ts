...
import { createAuditLogSchema, getAuditLogsSchema } from "./audit-logs.validation.js";
...
export const createAuditLog = async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
