...
type Notification = {
  ...
  status: "Read" | "Unread";
  recipientType: "User" | "Role" | "Broadcast";
  recipients: Array<any>;
  sender: any;
  relatedEntity?: { type?: string | null; id?: string | null; name?: string };
  actionable: boolean;
  actions: Array<any>;
  scheduledFor?: string;
  expiresAt?: string;
...
const mapDbToFrontend = (n: any): any => {
...
export const createNotification = async (data: any) => {
  ...
  const isCritical =
    frontendNotification.severity === "Critical" ||
...
export const updateNotificationDetails = async (id: string, data: any) => {
