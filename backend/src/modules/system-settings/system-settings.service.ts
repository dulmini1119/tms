...
const parseValue = (value: string | null, type: string | null, isEncrypted: boolean) => {
...
const stringifyValue = (value: any, type: string): string => {
...
export const SystemSettingsService = {
  ...
  upsertSetting: async (key: string, data: any, userId: string) => {
    // Check if exists
