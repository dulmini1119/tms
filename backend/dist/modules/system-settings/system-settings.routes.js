...
router.get('/', validateQuery(systemSettingsValidation.query), // Use validateQuery for req.query
...
router.post('/', validateBody(systemSettingsValidation.create), // Use validateBody for req.body
controller.createSetting);
// PUT /system-settings/:key - Update setting
router.put('/:key', validateBody(systemSettingsValidation.update), // Use validateBody for req.body
