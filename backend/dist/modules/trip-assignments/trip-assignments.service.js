...
const mapAssignmentToFrontend = (assignment) => {
    return {
        id: assignment.id,
        ...
        assignedDriver: {
            ...
            phoneNumber: assignment.drivers?.users_drivers_user_idTousers?.phone ||
...
const syncAssignmentToTripLog = async (assignment) => {
...
export const updateAssignment = async (id, data) => {
    ...
    if (vehicleId)
        assignmentUpdate.vehicle_id = vehicleId;
    if (driverId)
        assignmentUpdate.driver_id = driverId;
...
//# sourceMappingURL=trip-assignments.service.js.map