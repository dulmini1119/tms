 ...
 */
export const getTripCostById = async (req, res) => {
    try {
        const { id } = req.params;
 ...
 */
export const createTripCost = async (req, res) => {
    try {
        const payload = {
            ...req.body,
 ...
 */
export const updateTripCost = async (req, res) => {
    try {
        const { id } = req.params;
        const payload = {
            ...req.body,
 ...
 */
export const deleteTripCost = async (req, res) => {
    try {
        const { id } = req.params;
...
export const restrictEditIfFinalized = async (req, res, next) => {
    try {
        const { id } = req.params;
        ...
        const isFinalized = cost.payment_status === "Paid" ||
...
//# sourceMappingURL=trip-costs.controller.js.map