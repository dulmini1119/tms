...
export class CabAgreementsService {
    ...
    static async create(data, userId, documentUrl) {
    ...
    static async findMany(filters, page = 1, limit = 10) {
    ...
    static async update(id, data, userId, documentUrl) {
        const dbData = this.mapToDbFormat({ ...data, document_url: documentUrl });
...
//# sourceMappingURL=cab-agreements.services.js.map