...
export const findInvoiceByServiceMonth = (cabServiceId, month) => prisma.invoice.findFirst({
    where: { cab_service_id: cabServiceId, billing_month: month },
});
export const createDraftInvoice = (cabServiceId, month, userId) => prisma.invoice.create({
    data: {
...
export const getUninvoicedTrips = async (cabServiceId, month) => {
