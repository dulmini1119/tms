...
const buildDisplayAction = (log, actionType) => {
...
export const createAuditLog = async (data) => {
    const { userId, userName, userRole, action, module, entityType, entityId, entityName, changes, ipAddress, userAgent, status, errorMessage, description, } = data;
