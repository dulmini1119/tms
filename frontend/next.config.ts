...
const nextConfig: NextConfig = {
  ...
  async rewrites() {
    return [
      ...
      {
        source: "/gps-logs/:path*",
        destination: "http://localhost:3001/gps-logs/:path*",
      },
      {
        source: "/invoices",
        destination: "http://localhost:3001/invoices",
      },
      {
        source: "/invoices/:path*",
        destination: "http://localhost:3001/invoices/:path*",
      },
      {
        source: "/trip-costs",
        destination: "http://localhost:3001/trip-costs",
      },
      {
        source: "/trip-costs/:path*",
        destination: "http://localhost:3001/trip-costs/:path*",
      },
      {
        source: "/trip-logs",
      ...
      {
        source: "/trip-assignments/:path*",
        destination: "http://localhost:3001/trip-assignments/:path*",
      },
      {
        source: "/trip-approvals",
        destination: "http://localhost:3001/trip-approvals",
      },
      {
        source: "/trip-approvals/:path*",
        destination: "http://localhost:3001/trip-approvals/:path*",
      },
      {
        source: "/trip-requests",
        destination: "http://localhost:3001/trip-requests",
      },
      {
      ...
      // ── VEHICLE DOCUMENTS ─────────────────────────────────────
      {
        ...
        destination: "http://localhost:3001/vehicle-documents",
      },
      {
